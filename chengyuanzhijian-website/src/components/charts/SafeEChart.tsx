...
class ChartErrorBoundary extends Component<ChartErrorBoundaryProps, ChartErrorBoundaryState> {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div className="flex h-full min-h-[220px] w-full items-center justify-center rounded-xl border border-dashed border-white/14 bg-white/5 px-6 text-center text-sm leading-6 text-white/55">

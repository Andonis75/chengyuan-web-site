...
$baseDoc = Get-ChildItem -LiteralPath $projectPlanDir | Where-Object { $_.Name -like '*v34.docm' } | Select-Object -First 1 -ExpandProperty FullName
$outDoc = Join-Path $projectPlanDir "chengyuan_v35_tmp.docm"
$rewritePath = Join-Path $projectPlanDir "v35_rewrites.json"
...
$finalDoc = Join-Path $projectPlanDir ((Split-Path -Leaf $baseDoc) -replace 'v34\.docm$', 'v35.docm')
